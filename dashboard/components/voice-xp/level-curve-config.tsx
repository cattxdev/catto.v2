      ...
      <CardContent className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Define XP thresholds manually</div>
                </div>
              </div>
            </button>
          </div>
        ...
        {config.levelCurveType === 'FORMULA' && (
          <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div className="p-6 rounded-lg bg-gradient-to-br from-cyan-500/5 via-muted/20 to-blue-500/5 border border-cyan-500/20">
              ...
              <div className="grid grid-cols-5 gap-2 text-center">
                {[1, 5, 10, 25, 50].map((level) => (
                  <div key={level} className="p-3 rounded-lg bg-gradient-to-br from-muted/40 to-muted/20 border border-border/40 hover:from-cyan-500/10 hover:to-blue-500/10 hover:border-cyan-500/30 transition-all">
          ...
          <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Define XP required for each level. Values must be ascending.
              </p>
            </div>
            ...
            <div className="p-6 rounded-lg bg-gradient-to-br from-cyan-500/5 via-muted/20 to-blue-500/5 border border-cyan-500/20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-muted-foreground bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 rounded-full">
              ...
              <div className="grid grid-cols-5 gap-2 text-center max-h-32 overflow-y-auto">
                {config.tableThresholds.slice(0, 10).map((xp, index) => (
                  <div key={index} className="p-3 rounded-lg bg-gradient-to-br from-muted/40 to-muted/20 border border-border/40 hover:from-cyan-500/10 hover:to-blue-500/10 hover:border-cyan-500/30 transition-all">
