              ...
              <div className="overflow-y-auto pr-2 max-h-[calc(90vh-3rem)]">
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600">
                    This implementation provides a simple and secure way to add Discord authentication to your bot
                    dashboard, including user verification and enhanced security features.
                  </p>

                  <div className="space-y-2">
                    <h3 className="font-semibold">What You Get</h3>
                    <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                      <li>A clean, minimal login button that opens Discord's authentication popup</li>
                      <li>Secure user authentication using Discord's OAuth 2.0 protocol</li>
                      <li>User profile information including username, discriminator, avatar, and guilds</li>
                  ...
                  <div className="space-y-2">
                    ...
                    <ol className="list-decimal pl-5 text-sm text-gray-600 space-y-1">
                      ...
                      <li>After authenticating, Discord redirects to our callback URL with an authorization code</li>
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="list-disc pl-5 text-sm text-gray-600 space-y-1">
                      <li>Authentication cancellation - Gracefully handles when a user cancels the Discord login process</li>
                  ...
                  <div className="space-y-2">
                    ...
                    <ol className="list-decimal pl-5 text-sm text-gray-600 space-y-1">
                      ...
                      <li>
                        Set your redirect URI to: <code>https://your-domain.com/api/auth/callback</code>
                      </li>
                      <li>
