...
export class RewardsCommand extends Command {
        ...
        registry.registerChatInputCommand((builder) =>
            builder
                ...
                .addUserOption((opt) =>
                    opt
                        .setName('user')
                        .setDescription('View rewards for a specific user')
                )
        );
    }
    ...
    public override async chatInputRun(
        ...
        try {
            ...
            const userLevel = await this.getUserLevel(targetUser.id, interaction.guildId!);
            ...
            for (const level of sortedLevels) {
                ...
                const statusIcon = level <= userLevel ? EMOJIS.SUCCESS : level === userLevel + 1 ? EMOJIS.ARROW_UP : EMOJIS.LOCKED;
