 ...
 */
export async function resolveKeyForInteraction(interaction: Interaction, key: string, values?: Record<string, unknown>) {
 ...
 */
export async function resolveKeyForMessage(message: Message, key: string, values?: Record<string, unknown>) {
