...
export function validateUpdateVoiceXPConfig(dto: UpdateVoiceXPConfigDTO): { valid: boolean; errors: string[] } {
	const errors: string[] = [];
	...
	if (dto.levelCurveType !== undefined && !Object.values(VoiceLevelCurveType).includes(dto.levelCurveType)) {
