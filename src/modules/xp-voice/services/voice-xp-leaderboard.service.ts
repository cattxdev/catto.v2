...
import type { VoiceLeaderboardEntry, VoiceLeaderboardResponse, VoiceUserStatsResponse } from '../types/voice-xp.types';
...
export async function getVoiceUserStats(guildId: string, userId: string): Promise<VoiceUserStatsResponse | null> {
