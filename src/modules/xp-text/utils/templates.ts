 ...
 */
export function validateTemplate(template: string): { valid: boolean; unknownPlaceholders: string[] } {
...
export const DEFAULT_TEMPLATES = {
	...
	levelUpDetailed: '🎉 Congratulations {user}! You\'ve reached **Level {level}**! ({totalXp}/{nextLevelXp} XP)',
