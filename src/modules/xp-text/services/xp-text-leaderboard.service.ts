...
import type { LeaderboardResponse, LeaderboardEntry, UserStatsResponse } from '../types/xp-text.types';
 ...
 */
export async function getUserStats(guildId: string, userId: string): Promise<UserStatsResponse | null> {
