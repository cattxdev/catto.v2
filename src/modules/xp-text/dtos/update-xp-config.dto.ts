...
// Validation helper
export function validateUpdateXPConfig(dto: UpdateXPConfigDTO): { valid: boolean; errors: string[] } {
	const errors: string[] = [];
	...
	if (dto.levelCurveType !== undefined && !Object.values(LevelCurveType).includes(dto.levelCurveType)) {
