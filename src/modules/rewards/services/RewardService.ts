...
import { PrismaClient, LevelReward, UserRewardClaim } from '@prisma/client';
...
export class RewardService {
    ...
    async claimReward(
        ...
        const applyResult = await this.applyReward(
            reward,
            discordGuild,
            discordMember
        );
    ...
    private async applyReward(
        ...
        const rewardData = reward.rewardData as any;

        try {
            switch (reward.rewardType) {
                case RewardType.ROLE_ADD:
                case RewardType.ROLE_STACK: {
                    const data = rewardData as RoleRewardData;
                ...
                case RewardType.PERMISSION_GRANT: {
                    const data = rewardData as PermissionRewardData;
                ...
                case RewardType.CHANNEL_ACCESS: {
                    const data = rewardData as ChannelAccessRewardData;
                ...
                case RewardType.CURRENCY_GRANT: {
                    const data = rewardData as CurrencyRewardData;
                ...
                case RewardType.XP_MULTIPLIER: {
                    const data = rewardData as MultiplierRewardData;
                ...
                case RewardType.ANNOUNCEMENT: {
                    const data = rewardData as AnnouncementRewardData;
                                ...
                                embeds: [
                                    {
                                        ...
                                        thumbnail: data.embedConfig.thumbnail
                                            ...
                                            : undefined,
                                        footer: data.embedConfig.footer
                                            ? { text: data.embedConfig.footer }
                                            : undefined,
                                    },
                                ],
                            });
    ...
    async createReward(config: LevelRewardConfig): Promise<LevelRewardConfig> {
        const reward = await this.prisma.levelReward.create({
            data: {
                ...
                rewardData: config.rewardData as any,
                name: config.name,
    ...
    async updateReward(
        ...
        const reward = await this.prisma.levelReward.update({
            ...
            data: {
                ...
                rewardData: updates.rewardData as any,
                name: updates.name,
    ...
    private mapToConfig(reward: LevelReward): LevelRewardConfig {
        return {
            ...
            rewardData: reward.rewardData as any,
            name: reward.name,
